...
# Read Metadata
serratia_metadata <- read_tsv("MosAIC_V1/06a_SerratiaPopulationStructure/Serratia_Curated_Metadata_2.txt")
...
S_metadata <- read_tsv("MosAIC_V1/06a_SerratiaPopulationStructure/Serratia_Curated_Metadata_2.txt") %>%
  clean_names() 
